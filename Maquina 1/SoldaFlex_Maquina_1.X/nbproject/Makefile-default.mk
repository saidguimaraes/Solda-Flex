...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/SoldaFlex_Maquina_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/SoldaFlex_Maquina_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq (1,1) 
	...
	@mv ${OBJECTDIR}/_ext/1472/main.cof "dist/${CND_CONF}/${IMAGE_TYPE}/SoldaFlex_Maquina_1.X.${IMAGE_TYPE}.cof" 
	@mv ${OBJECTDIR}/_ext/1472/main.hex "dist/${CND_CONF}/${IMAGE_TYPE}/SoldaFlex_Maquina_1.X.${IMAGE_TYPE}.hex"
else 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/SoldaFlex_Maquina_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
ifeq (1,1) 
	
else 
	${MP_LD}   out="dist/${CND_CONF}/${IMAGE_TYPE}"  +FH +DF +CC LINK=SoldaFlex_Maquina_1.X.${IMAGE_TYPE}.hex=${OBJECTDIR}/_ext/1472/main.o +Y=9 +EA +DF +LN +T +A +M +J +EA +Z -P
